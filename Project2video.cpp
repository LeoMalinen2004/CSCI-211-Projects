...
// Class constructor
Video::Video(string title, string url, string comment, double length,
             int rating) {
  m_title = title;
  m_url = url;
  m_comment = comment;
...
string Video::titles() { return m_title; }
double Video::lengths() { return m_length; }
double Video::rating() { return m_length; }
